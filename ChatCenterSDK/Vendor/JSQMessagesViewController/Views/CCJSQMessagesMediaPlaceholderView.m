...
@implementation CCJSQMessagesMediaPlaceholderView
...
+ (instancetype)viewWithActivityIndicator
{
    ...
    CCJSQMessagesMediaPlaceholderView *view = [[CCJSQMessagesMediaPlaceholderView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 200.0f, 120.0f)
