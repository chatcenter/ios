 ...
 */
@property (weak, nonatomic) id<CCJSQMessagesCollectionViewCellDelegate> delegate;

/**
 *  Returns the label that is pinned to the top of the cell.
 *  This label is most commonly used to display message timestamps.
 */
@property (weak, nonatomic, readonly) CCJSQMessagesLabel *cellTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) CCJSQMessagesLabel *messageBubbleTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) CCJSQMessagesLabel *cellBottomLabel;
 ...
 */
@property (weak, nonatomic, readonly) CCJSQMessagesCellTextView *textView;
