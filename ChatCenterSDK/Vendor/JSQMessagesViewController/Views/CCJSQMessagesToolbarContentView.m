...
@interface CCJSQMessagesToolbarContentView ()

@property (weak, nonatomic) IBOutlet CCJSQMessagesComposerTextView *textView;
...
@implementation CCJSQMessagesToolbarContentView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([CCJSQMessagesToolbarContentView class])
                          bundle:[NSBundle bundleForClass:[CCJSQMessagesToolbarContentView class]]];
}
...
- (void)setLeftBarButtonItem:(UIButton *)leftBarButtonItem
{
    ...
    [leftBarButtonItem setTranslatesAutoresizingMaskIntoConstraints:YES];
    [leftBarButtonItem.imageView setContentMode:UIViewContentModeScaleAspectFit];
