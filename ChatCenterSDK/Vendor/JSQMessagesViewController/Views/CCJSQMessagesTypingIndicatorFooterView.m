...
@interface CCJSQMessagesTypingIndicatorFooterView ()
...
@implementation CCJSQMessagesTypingIndicatorFooterView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([CCJSQMessagesTypingIndicatorFooterView class])
                          bundle:[NSBundle bundleForClass:[CCJSQMessagesTypingIndicatorFooterView class]]];
}

+ (NSString *)footerReuseIdentifier
{
    return NSStringFromClass([CCJSQMessagesTypingIndicatorFooterView class]);
}
                 ...
                 forCollectionView:(UICollectionView *)collectionView
{
    ...
    CCJSQMessagesBubbleImageFactory *bubbleImageFactory = [[CCJSQMessagesBubbleImageFactory alloc] init];
