...
@interface CCJSQMessagesCollectionViewCell ()

@property (weak, nonatomic) IBOutlet CCJSQMessagesLabel *cellTopLabel;
@property (weak, nonatomic) IBOutlet CCJSQMessagesLabel *messageBubbleTopLabel;
@property (weak, nonatomic) IBOutlet CCJSQMessagesLabel *cellBottomLabel;

@property (weak, nonatomic) IBOutlet UIView *messageBubbleContainerView;
@property (weak, nonatomic) IBOutlet UIImageView *messageBubbleImageView;
@property (weak, nonatomic) IBOutlet CCJSQMessagesCellTextView *textView;
...
@implementation CCJSQMessagesCollectionViewCell
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    CCJSQMessagesCollectionViewLayoutAttributes *customAttributes = (CCJSQMessagesCollectionViewLayoutAttributes *)layoutAttributes;
    ...
    if ([self isKindOfClass:[CCJSQMessagesCollectionViewCellIncoming class]]) {
        self.avatarViewSize = customAttributes.incomingAvatarViewSize;
    }
    else if ([self isKindOfClass:[CCJSQMessagesCollectionViewCellOutgoing class]]) {
