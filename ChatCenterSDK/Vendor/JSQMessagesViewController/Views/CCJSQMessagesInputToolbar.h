...
@class CCJSQMessagesInputToolbar;
 ...
 */
- (void)messagesInputToolbar:(CCJSQMessagesInputToolbar *)toolbar
 ...
 */
@property (weak, nonatomic) id<CCJSQMessagesInputToolbarDelegate> delegate;

/**
 *  Returns the content view of the toolbar. This view contains all subviews of the toolbar.
 */
@property (weak, nonatomic, readonly) CCJSQMessagesToolbarContentView *contentView;
