...
/**
 *  An instance of `CCJSQMessagesBubblesSizeCalculator` is responsible for calculating
 *  message bubble sizes for an instance of `CCJSQMessagesCollectionViewFlowLayout`.
 */
@interface CCJSQMessagesBubblesSizeCalculator : NSObject <CCJSQMessagesBubbleSizeCalculating>
 ...
 *
 *  @return An initialized `CCJSQMessagesBubblesSizeCalculator` object if successful, `nil` otherwise.
 */
