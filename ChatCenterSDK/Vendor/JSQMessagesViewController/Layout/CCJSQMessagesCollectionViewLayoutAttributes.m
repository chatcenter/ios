...
@interface CCJSQMessagesCollectionViewLayoutAttributes ()
...
@implementation CCJSQMessagesCollectionViewLayoutAttributes
...
- (BOOL)isEqual:(id)object
{
    ...
    if (self.representedElementCategory == UICollectionElementCategoryCell) {
        CCJSQMessagesCollectionViewLayoutAttributes *layoutAttributes = (CCJSQMessagesCollectionViewLayoutAttributes *)object;
...
{
    CCJSQMessagesCollectionViewLayoutAttributes *copy = [super copyWithZone:zone];
