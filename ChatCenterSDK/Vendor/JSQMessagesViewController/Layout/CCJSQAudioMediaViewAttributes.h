...
/**
 An instance of `CCJSQAudioMediaViewAttributes` specifies the appearance configuration of a `CCJSQAudioMediaItem`.
 Use this class to customize the appearance of `CCJSQAudioMediaItem`.
 */
@interface CCJSQAudioMediaViewAttributes : NSObject
...
/**
 Initializes and returns a `CCJSQAudioMediaViewAttributes` instance having the specified attributes.
 ...
 @return A new `CCJSQAudioMediaViewAttributes` instance
 */
...
/**
 Initializes and returns a default `CCJSQAudioMediaViewAttributes` instance.
