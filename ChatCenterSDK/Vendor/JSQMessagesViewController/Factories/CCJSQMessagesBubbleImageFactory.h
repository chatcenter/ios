...
/**
 *  `CCJSQMessagesBubbleImageFactory` is a factory that provides a means for creating and styling 
 *  `CCJSQMessagesBubbleImage` objects to be displayed in a `CCJSQMessagesCollectionViewCell` of a `CCJSQMessagesCollectionView`.
 */
@interface CCJSQMessagesBubbleImageFactory : NSObject

/**
 *  Creates and returns a new instance of `CCJSQMessagesBubbleImageFactory` that uses the
 *  default bubble image assets and cap insets.
 *
 *  @return An initialized `CCJSQMessagesBubbleImageFactory` object if created successfully, `nil` otherwise.
 */
- (instancetype)init;

/**
 *  Creates and returns a new instance of `CCJSQMessagesBubbleImageFactory` having the specified
 *  bubbleImage and capInsets. These values are used internally in the factory to produce
 *  `CCJSQMessagesBubbleImage` objects.
 *
...
/**
 *  Creates and returns a `CCJSQMessagesBubbleImage` object with the specified color for *outgoing* message image bubbles.
 *  The `messageBubbleImage` property of the `CCJSQMessagesBubbleImage` is configured with a flat bubble image, masked to the given color.
 ...
 *
 *  @return An initialized `CCJSQMessagesBubbleImage` object if created successfully, `nil` otherwise.
 */
- (CCJSQMessagesBubbleImage *)outgoingMessagesBubbleImageWithColor:(UIColor *)color;

/**
 *  Creates and returns a `CCJSQMessagesBubbleImage` object with the specified color for *incoming* message image bubbles.
 *  The `messageBubbleImage` property of the `CCJSQMessagesBubbleImage` is configured with a flat bubble image, masked to the given color.
 *  The `messageBubbleHighlightedImage` property is configured similarly, but with a darkened version of the given color.
 *
 *  @param color The color of the bubble image in the image view. This value must not be `nil`.
