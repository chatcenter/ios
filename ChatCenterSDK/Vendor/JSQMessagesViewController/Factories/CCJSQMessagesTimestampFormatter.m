...
@interface CCJSQMessagesTimestampFormatter ()
...
@implementation CCJSQMessagesTimestampFormatter

#pragma mark - Initialization

+ (CCJSQMessagesTimestampFormatter *)sharedFormatter
{
    static CCJSQMessagesTimestampFormatter *_sharedFormatter = nil;
    
    static dispatch_once_t onceToken = 0;
    dispatch_once(&onceToken, ^{
        _sharedFormatter = [[CCJSQMessagesTimestampFormatter alloc] init];
    });
