...
#import "CCJSQMessagesKeyboardController.h"
 ...
 */
@interface CCJSQMessagesViewController : UIViewController <CCJSQMessagesCollectionViewDataSource,
                                                         CCJSQMessagesCollectionViewDelegateFlowLayout,
                                                         UITextViewDelegate>
 ...
 */
@property (weak, nonatomic, readonly) CCJSQMessagesCollectionView *collectionView;

/**
 *  Returns the input toolbar view object managed by this view controller.
 *  This view controller is the toolbar's delegate.
 */
@property (weak, nonatomic, readonly) CCJSQMessagesInputToolbar *inputToolbar;

/**
 *  Returns the keyboard controller object used to manage the software keyboard.
 */
@property (strong, nonatomic) CCJSQMessagesKeyboardController *keyboardController;
