...
CCJSQMessagesKeyboardControllerDelegate>
...
+ (void)initialize {
    [super initialize];
    if (self == [CCJSQMessagesViewController self]) {
...
- (void)jsq_configureMessagesViewController
{
    ...
    // [CCJSQMessagesCollectionViewCell registerMenuAction:@selector(delete:)];
...
{
    CCJSQMessagesCollectionViewFlowLayoutInvalidationContext *context = [CCJSQMessagesCollectionViewFlowLayoutInvalidationContext context];
...
- (BOOL)isOutgoingMessage:(id<CCJSQMessageData>)messageItem
{
...
#pragma mark - CCJSQMessages collection view data source
...
- (void)collectionView:(CCJSQMessagesCollectionView *)collectionView
  accessibilityForCell:(CCJSQMessagesCollectionViewCell*)cell
             indexPath:(NSIndexPath *)indexPath
               message:(id<CCJSQMessageData>)messageItem
{
...
{
    UIEdgeInsets contentInsets = UIEdgeInsetsMake(top, 0.0f, bottom + 20, 0.0f);
