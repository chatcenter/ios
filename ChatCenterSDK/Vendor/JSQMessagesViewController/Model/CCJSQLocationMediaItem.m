...
@interface CCJSQLocationMediaItem ()
...
@implementation CCJSQLocationMediaItem
...
- (UIView *)mediaView
{
    ...
    if (self.cachedMapImageView == nil) {
        ...
        [CCJSQMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:imageView isOutgoing:self.appliesMediaViewMaskAsOutgoing];
...
- (BOOL)isEqual:(id)object
{
    ...
    CCJSQLocationMediaItem *locationItem = (CCJSQLocationMediaItem *)object;
...
{
    CCJSQLocationMediaItem *copy = [[[self class] allocWithZone:zone] initWithLocation:self.location];
