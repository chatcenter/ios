...
@implementation CCJSQVideoMediaItem
...
- (BOOL)isEqual:(id)object
{
    ...
    CCJSQVideoMediaItem *videoItem = (CCJSQVideoMediaItem *)object;
...
{
    CCJSQVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL
