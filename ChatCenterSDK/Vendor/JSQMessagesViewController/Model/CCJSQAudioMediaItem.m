...
#import "CCJSQMessagesMediaPlaceholderView.h"
...
@implementation CCJSQAudioMediaItem

#pragma mark - Initialization

- (instancetype)initWithData:(NSData *)audioData audioViewAttributes:(CCJSQAudioMediaViewAttributes *)audioViewAttributes
{
...
{
    return [self initWithData:audioData audioViewAttributes:[[CCJSQAudioMediaViewAttributes alloc] init]];
}
...
- (instancetype)init
{
    return [self initWithData:nil audioViewAttributes:[[CCJSQAudioMediaViewAttributes alloc] init]];
}
...
- (UIView *)mediaView
{
    if (self.audioData && self.cachedMediaView == nil) {
        ...
        [CCJSQMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:playView isOutgoing:self.appliesMediaViewMaskAsOutgoing];
...
- (BOOL)isEqual:(id)object
{
    ...
    CCJSQAudioMediaItem *audioItem = (CCJSQAudioMediaItem *)object;
...
{
    CCJSQAudioMediaItem *copy = [[[self class] allocWithZone:zone] initWithData:self.audioData
