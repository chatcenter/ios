...
@implementation CCJSQMessagesAvatarImage 
...
+ (instancetype)avatarWithImage:(UIImage *)image
{
    ...
    return [[CCJSQMessagesAvatarImage alloc] initWithAvatarImage:image
...
{
    return [[CCJSQMessagesAvatarImage alloc] initWithAvatarImage:nil
