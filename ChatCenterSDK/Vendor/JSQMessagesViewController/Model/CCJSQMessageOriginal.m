...
@interface CCJSQMessageOriginal ()
...
@implementation CCJSQMessageOriginal
...
+ (instancetype)messageWithSenderId:(NSString *)senderId
                        displayName:(NSString *)displayName
                               text:(NSString *)text
{
    return [[CCJSQMessageOriginal alloc] initWithSenderId:senderId
...
- (BOOL)isEqual:(id)object
{
    ...
    CCJSQMessageOriginal *aMessage = (CCJSQMessageOriginal *)object;
