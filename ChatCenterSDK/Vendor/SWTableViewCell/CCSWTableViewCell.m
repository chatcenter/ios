...
#import "CCSWUtilityButtonView.h"
...
@interface CCSWTableViewCell () <UIScrollViewDelegate,  UIGestureRecognizerDelegate>

@property (nonatomic, weak) UITableView *containingTableView;

@property (nonatomic, strong) UIPanGestureRecognizer *tableViewPanGestureRecognizer;

@property (nonatomic, assign) CCSWCellState cellState; // The state of the cell within the scroll view, can be left, right or middle
@property (nonatomic, assign) CGFloat additionalRightPadding;

@property (nonatomic, strong) UIScrollView *cellScrollView;
@property (nonatomic, strong) CCSWUtilityButtonView *leftUtilityButtonsView, *rightUtilityButtonsView;
...
- (CGPoint)contentOffsetForCellState:(CCSWCellState)state;
...
@implementation CCSWTableViewCell {
...
- (void)initializer
{
    ...
    self.cellScrollView = [[CCSWCellScrollView alloc] init];
    ...
    self.longPressGestureRecognizer = [[CCSWLongPressGestureRecognizer alloc] initWithTarget:self action:@selector(scrollViewPressed:)];
    ...
    self.leftUtilityButtonsView = [[CCSWUtilityButtonView alloc] initWithUtilityButtons:nil
                                                                           parentCell:self
    ...
    self.rightUtilityButtonsView = [[CCSWUtilityButtonView alloc] initWithUtilityButtons:nil
                                                                            parentCell:self
...
{
    CCSWUtilityButtonTapGestureRecognizer *utilityButtonTapGestureRecognizer = (CCSWUtilityButtonTapGestureRecognizer *)sender;
...
- (void)updateCellState
{
    if(layoutUpdating == NO)
    {
        ...
        {
            CCSWCellState cellState = numState.integerValue;
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
    ...
    if (_cellState != kCellStateCenter)
    {
        if ([self.delegate respondsToSelector:@selector(swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:)])
        {
            for (CCSWTableViewCell *cell in [self.containingTableView visibleCells]) {
                if (cell != self && [cell isKindOfClass:[CCSWTableViewCell class]] && [self.delegate swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:cell]) {
