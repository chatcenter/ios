...
@interface CCSWUtilityButtonView()
...
@implementation CCSWUtilityButtonView

#pragma mark - CCSWUtilityButonView initializers
...
- (void)setUtilityButtons:(NSArray *)utilityButtons WithButtonWidth:(CGFloat)width
{
    ...
    if (utilityButtons.count)
    {
        ...
        for (UIButton *button in _utilityButtons)
        {
            ...
            CCSWUtilityButtonTapGestureRecognizer *utilityButtonTapGestureRecognizer = [[CCSWUtilityButtonTapGestureRecognizer alloc] initWithTarget:_parentCell action:_utilityButtonSelector];
