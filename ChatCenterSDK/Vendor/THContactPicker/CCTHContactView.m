...
@interface CCTHContactView ()<THContactTextFieldDelegate>{
	CGFloat _horizontalPadding;
}

@end

@implementation CCTHContactView
...
- (id)initWithName:(NSString *)name style:(CCTHContactViewStyle *)style selectedStyle:(CCTHContactViewStyle *)selectedStyle showComma:(BOOL)showComma {
    ...
    if (self){
        ...
        // default styles
        if (style == nil) {
            style = [[CCTHContactViewStyle alloc] initWithTextColor:k7ColorText
        ...
        if (selectedStyle == nil) {
            selectedStyle = [[CCTHContactViewStyle alloc] initWithTextColor:k7ColorSelectedText
