...
@interface CCTHContactPickerView : UIView <UITextViewDelegate, THContactViewDelegate, UIScrollViewDelegate, UITextInputTraits>

@property (nonatomic, strong) CCTHContactView *selectedContactView;
...
// View Customization
- (void)setContactViewStyle:(CCTHContactViewStyle *)color selectedStyle:(CCTHContactViewStyle *)selectedColor;
