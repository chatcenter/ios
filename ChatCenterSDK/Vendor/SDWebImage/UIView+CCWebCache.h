...
typedef void(^CCSDSetImageBlock)(UIImage * _Nullable image, NSData * _Nullable imageData);
 ...
 * @param options        The options to use when downloading the image. @see CCSDWebImageOptions for the possible values.
