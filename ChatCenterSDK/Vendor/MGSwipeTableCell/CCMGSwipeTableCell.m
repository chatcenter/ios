...
@interface CCMGSwipeTableInputOverlay : UIView
@property (nonatomic, weak) CCMGSwipeTableCell * currentCell;
@end

@implementation CCMGSwipeTableInputOverlay
...
@interface CCMGSwipeButtonsView : UIView
@property (nonatomic, weak) CCMGSwipeTableCell * cell;
@property (nonatomic, strong) UIColor * backgroundColorCopy;
@end

@implementation CCMGSwipeButtonsView
{
    NSArray * _buttons;
    UIView * _container;
    BOOL _fromLeft;
    ...
    CCMGSwipeExpansionLayout _expansionLayout;
...
-(instancetype) initWithButtons:(NSArray*) buttonsArray direction:(CCMGSwipeDirection) direction differentWidth:(BOOL) differentWidth
{
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, containerWidth, maxSize.height)]) {
        _fromLeft = direction == CCMGSwipeDirectionLeftToRight;
...
-(void) expandToOffset:(CGFloat) offset settings:(CCMGSwipeExpansionSettings*) settings
{
    ...
    if (!_expandedButton) {
        ...
        [UIView animateWithDuration: duration delay:0 options:UIViewAnimationOptionBeginFromCurrentState animations:^{
            ...
            if (_expansionLayout == CCMGSwipeExpansionLayoutCenter) {
...
#pragma clang diagnostic pop
    ...
    if (_cell.delegate && [_cell.delegate respondsToSelector:@selector(swipeTableCell:tappedButtonAtIndex:direction:fromExpansion:)]) {
        ...
        autoHide|= [_cell.delegate swipeTableCell:_cell tappedButtonAtIndex:index direction:_fromLeft ? CCMGSwipeDirectionLeftToRight : CCMGSwipeDirectionRightToLeft fromExpansion:fromExpansion];
    }
...
-(void) transition:(CCMGSwipeTransition) mode percent:(CGFloat) t
{
    switch (mode) {
        case CCMGSwipeTransitionStatic: [self transitionStatic:t]; break;
        case CCMGSwipeTransitionDrag: [self transitionDrag:t]; break;
        case CCMGSwipeTransitionClipCenter: [self transitionClip:t]; break;
        case CCMGSwipeTransitionBorder: [self transtitionFloatBorder:t]; break;
        case CCMGSwipeTransitionRotate3D: [self transition3D:t]; break;
    }
...
@implementation CCMGSwipeSettings
-(instancetype) init
{
    if (self = [super init]) {
        self.transition = CCMGSwipeTransitionBorder;
        self.threshold = 0.5;
        self.offset = 0;
        self.keepButtonsSwiped = YES;
        self.enableSwipeBounces = YES;
        self.swipeBounceRate = 1.0;
        self.showAnimation = [[CCMGSwipeAnimation alloc] init];
        self.hideAnimation = [[CCMGSwipeAnimation alloc] init];
        self.stretchAnimation = [[CCMGSwipeAnimation alloc] init];
    }
    return self;
}
...
@implementation CCMGSwipeExpansionSettings
-(instancetype) init
{
    if (self = [super init]) {
        self.buttonIndex = -1;
        ...
        self.triggerAnimation = [[CCMGSwipeAnimation alloc] init];
    }
    return self;
}
@end

@interface CCMGSwipeAnimationData : NSObject
...
@property (nonatomic, strong) CCMGSwipeAnimation * animation;

@end

@implementation CCMGSwipeAnimationData
@end


#pragma mark Easing Functions and CCMGSwipeAnimation
...
@implementation CCMGSwipeAnimation

-(instancetype) init {
    if (self = [super init]) {
        _duration = 0.3;
        _easingFunction = CCMGSwipeEasingFunctionCubicOut;
    }
    return self;
}
...
-(CGFloat) value:(CGFloat)elapsed duration:(CGFloat)duration from:(CGFloat)from to:(CGFloat)to
{
    ...
    switch (_easingFunction) {
        case CCMGSwipeEasingFunctionLinear: easingFunction = mgEaseLinear;break;
        case CCMGSwipeEasingFunctionQuadIn: easingFunction = mgEaseInQuad;break;
        case CCMGSwipeEasingFunctionQuadOut: easingFunction = mgEaseOutQuad;break;
        case CCMGSwipeEasingFunctionQuadInOut: easingFunction = mgEaseInOutQuad;break;
        case CCMGSwipeEasingFunctionCubicIn: easingFunction = mgEaseInCubic;break;
        default:
        case CCMGSwipeEasingFunctionCubicOut: easingFunction = mgEaseOutCubic;break;
        case CCMGSwipeEasingFunctionCubicInOut: easingFunction = mgEaseInOutCubic;break;
        case CCMGSwipeEasingFunctionBounceIn: easingFunction = mgEaseInBounce;break;
        case CCMGSwipeEasingFunctionBounceOut: easingFunction = mgEaseOutBounce;break;
        case CCMGSwipeEasingFunctionBounceInOut: easingFunction = mgEaseInOutBounce;break;
    }
...
#pragma mark CCMGSwipeTableCell Implementation


@implementation CCMGSwipeTableCell
{
    ...
    CCMGSwipeButtonsView * _leftView;
    CCMGSwipeButtonsView * _rightView;
    bool _allowSwipeRightToLeft;
    bool _allowSwipeLeftToRight;
    __weak CCMGSwipeButtonsView * _activeExpansion;

    CCMGSwipeTableInputOverlay * _tableInputOverlay;
    ...
    CCMGSwipeAnimationData * _animationData;
    void (^_animationCompletion)(BOOL finished);
    CADisplayLink * _displayLink;
    CCMGSwipeState _firstSwipeState;
}
...
-(void) initViews: (BOOL) cleanButtons
{
    if (cleanButtons) {
        ...
        _leftSwipeSettings = [[CCMGSwipeSettings alloc] init];
        _rightSwipeSettings = [[CCMGSwipeSettings alloc] init];
        _leftExpansion = [[CCMGSwipeExpansionSettings alloc] init];
        _rightExpansion = [[CCMGSwipeExpansionSettings alloc] init];
    }
    _animationData = [[CCMGSwipeAnimationData alloc] init];
...
-(void) fetchButtonsIfNeeded
{
    if (_leftButtons.count == 0 && _delegate && [_delegate respondsToSelector:@selector(swipeTableCell:swipeButtonsForDirection:swipeSettings:expansionSettings:)]) {
        _leftButtons = [_delegate swipeTableCell:self swipeButtonsForDirection:CCMGSwipeDirectionLeftToRight swipeSettings:_leftSwipeSettings expansionSettings:_leftExpansion];
    }
    if (_rightButtons.count == 0 && _delegate && [_delegate respondsToSelector:@selector(swipeTableCell:swipeButtonsForDirection:swipeSettings:expansionSettings:)]) {
        _rightButtons = [_delegate swipeTableCell:self swipeButtonsForDirection:CCMGSwipeDirectionRightToLeft swipeSettings:_rightSwipeSettings expansionSettings:_rightExpansion];
    }
}
...
-(void) createSwipeViewIfNeeded
{
    ...
    if (!_leftView && _leftButtons.count > 0) {
        _leftView = [[CCMGSwipeButtonsView alloc] initWithButtons:_leftButtons direction:CCMGSwipeDirectionLeftToRight differentWidth:_allowsButtonsWithDifferentWidth];
        _leftView.cell = self;
    ...
    if (!_rightView && _rightButtons.count > 0) {
        _rightView = [[CCMGSwipeButtonsView alloc] initWithButtons:_rightButtons direction:CCMGSwipeDirectionRightToLeft differentWidth:_allowsButtonsWithDifferentWidth];
...
- (void) showSwipeOverlayIfNeeded
{
    ...
    if (!_allowsMultipleSwipe) {
        ...
        _tableInputOverlay = [[CCMGSwipeTableInputOverlay alloc] initWithFrame:table.bounds];
...
-(void) prepareForReuse
{
    ...
    [self cleanViews];
    if (_swipeState != CCMGSwipeStateNone) {
        _triggerStateChanges = YES;
        [self updateState:CCMGSwipeStateNone];
    }
...
-(void) updateState: (CCMGSwipeState) newState;
{
...
- (void)setSwipeOffset:(CGFloat) newOffset;
{
    ...
    CCMGSwipeButtonsView * activeButtons = sign < 0 ? _rightView : _leftView;
    CCMGSwipeSettings * activeSettings = sign < 0 ? _rightSwipeSettings : _leftSwipeSettings;
    ...
    CCMGSwipeButtonsView* but[2] = {_leftView, _rightView};
    CCMGSwipeSettings* settings[2] = {_leftSwipeSettings, _rightSwipeSettings};
    CCMGSwipeExpansionSettings * expansions[2] = {_leftExpansion, _rightExpansion};
    
    for (int i = 0; i< 2; ++i) {
        CCMGSwipeButtonsView * view = but[i];
        if (!view) continue;
        ...
        if (expand) {
            ...
            [self updateState:i ? CCMGSwipeStateExpandingRightToLeft : CCMGSwipeStateExpandingLeftToRight];
        }
        else {
            ...
            [self updateState:i ? CCMGSwipeStateSwipingRightToLeft : CCMGSwipeStateSwipingLeftToRight];
        }
    }
}
...
{
    CCMGSwipeAnimation * animation = animated ? (_swipeOffset > 0 ? _leftSwipeSettings.hideAnimation: _rightSwipeSettings.hideAnimation) : nil;
...
-(void) showSwipe: (CCMGSwipeDirection) direction animated: (BOOL) animated completion:(void(^)(BOOL finished)) completion
{
    [self createSwipeViewIfNeeded];
    _allowSwipeLeftToRight = _leftButtons.count > 0;
    _allowSwipeRightToLeft = _rightButtons.count > 0;
    UIView * buttonsView = direction == CCMGSwipeDirectionLeftToRight ? _leftView : _rightView;
    
    if (buttonsView) {
        CGFloat s = direction == CCMGSwipeDirectionLeftToRight ? 1.0 : -1.0;
        CCMGSwipeAnimation * animation = animated ? (direction == CCMGSwipeDirectionLeftToRight ? _leftSwipeSettings.showAnimation : _rightSwipeSettings.showAnimation) : nil;
...
{
    CGFloat s = direction == CCMGSwipeDirectionLeftToRight ? 1.0 : -1.0;
    CCMGSwipeExpansionSettings* expSetting = direction == CCMGSwipeDirectionLeftToRight ? _leftExpansion : _rightExpansion;
    ...
    if(!_activeExpansion && expSetting.fillOnTrigger) {
        ...
        if (buttonsView) {
            __weak CCMGSwipeButtonsView * expansionView = direction == CCMGSwipeDirectionLeftToRight ? _leftView : _rightView;
            __weak CCMGSwipeTableCell * weakself = self;
...
{
    CCMGSwipeAnimation * animation = animated ? [[CCMGSwipeAnimation alloc] init] : nil;
    [self setSwipeOffset:offset animation:animation completion:completion];
}

-(void) setSwipeOffset:(CGFloat)offset animation: (CCMGSwipeAnimation *) animation completion:(void(^)(BOOL finished)) completion
{
    if (_displayLink) {
        [_displayLink invalidate];
        _displayLink = nil;
...
-(CGFloat) filterSwipe: (CGFloat) offset
{
    ...
    else if (!_allowsOppositeSwipe && _firstSwipeState == CCMGSwipeStateSwipingLeftToRight && offset < 0) {
        offset = 0;
    }
    else if (!_allowsOppositeSwipe && _firstSwipeState == CCMGSwipeStateSwipingRightToLeft && offset > 0 ) {
        offset = 0;
    }
    return offset;
}
...
-(void) panHandler: (UIPanGestureRecognizer *)gesture
{
    ...
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        if (_swipeOffset != 0) {
            _firstSwipeState = _swipeOffset > 0 ? CCMGSwipeStateSwipingLeftToRight : CCMGSwipeStateSwipingRightToLeft;
        }
        
        if (!_allowsMultipleSwipe) {
            NSArray * cells = [self parentTable].visibleCells;
            for (CCMGSwipeTableCell * cell in cells) {
                if ([cell isKindOfClass:[CCMGSwipeTableCell class]] && cell != self) {
        ...
        if (_firstSwipeState == CCMGSwipeStateNone) {
            _firstSwipeState = offset > 0 ? CCMGSwipeStateSwipingLeftToRight : CCMGSwipeStateSwipingRightToLeft;
        }
        self.swipeOffset = [self filterSwipe:offset];
    }
    else {
        __weak CCMGSwipeButtonsView * expansion = _activeExpansion;
        if (expansion) {
            __weak UIView * expandedButton = [expansion getExpandedButton];
            CCMGSwipeExpansionSettings * expSettings = _swipeOffset > 0 ? _leftExpansion : _rightExpansion;
            ...
            CCMGSwipeSettings * settings = _swipeOffset > 0 ? _leftSwipeSettings : _rightSwipeSettings;
            CCMGSwipeAnimation * animation = nil;
            if (_targetOffset == 0) {
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer == _panRecognizer) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(swipeTableCell:canSwipe:fromPoint:)]) {
            ...
            _allowSwipeLeftToRight = [_delegate swipeTableCell:self canSwipe:CCMGSwipeDirectionLeftToRight fromPoint:point];
            _allowSwipeRightToLeft = [_delegate swipeTableCell:self canSwipe:CCMGSwipeDirectionRightToLeft fromPoint:point];
        }
        else if (_delegate && [_delegate respondsToSelector:@selector(swipeTableCell:canSwipe:)]) {
            #pragma clang diagnostic push
            #pragma clang diagnostic ignored "-Wdeprecated-declarations"
            _allowSwipeLeftToRight = [_delegate swipeTableCell:self canSwipe:CCMGSwipeDirectionLeftToRight];
            _allowSwipeRightToLeft = [_delegate swipeTableCell:self canSwipe:CCMGSwipeDirectionRightToLeft];
            #pragma clang diagnostic pop
        }
        else {
            [self fetchButtonsIfNeeded];
