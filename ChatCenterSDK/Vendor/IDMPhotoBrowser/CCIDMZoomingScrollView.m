...
@interface CCIDMZoomingScrollView ()
@property (nonatomic, weak) CCIDMPhotoBrowser *photoBrowser;
- (void)handleSingleTap:(CGPoint)touchPoint;
- (void)handleDoubleTap:(CGPoint)touchPoint;
@end

@implementation CCIDMZoomingScrollView
...
- (id)initWithPhotoBrowser:(CCIDMPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView = [[CCIDMTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[CCIDMTapDetectingImageView alloc] initWithFrame:CGRectZero];
        ...
        // Progress view
        _progressView = [[CCDACircularProgressView alloc] initWithFrame:CGRectMake((screenWidth-35.)/2., (screenHeight-35.)/2, 35.0f, 35.0f)];
...
- (void)setPhoto:(id<CCIDMPhoto>)photo {
...
- (void)setProgress:(CGFloat)progress forPhoto:(CCIDMPhoto*)photo {
    CCIDMPhoto *p = (CCIDMPhoto*)self.photo;
