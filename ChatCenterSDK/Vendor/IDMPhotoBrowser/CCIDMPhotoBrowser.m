...
NSLocalizedStringFromTableInBundle((key), nil, [NSBundle bundleWithPath:[[NSBundle bundleForClass: [CCIDMPhotoBrowser class]] pathForResource:@"IDMPBLocalizations" ofType:@"bundle"]], nil)
#endif
    ...
    if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
        if(!_actionButtonTitles)
        {
			...
			if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
				...
				[popover presentPopoverFromRect:CGRectMake(self.view.frame.size.width - 50, self.view.frame.size.height - 50, 50, 50)
