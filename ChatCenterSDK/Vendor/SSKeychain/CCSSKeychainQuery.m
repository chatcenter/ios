...
#import "CCSSKeychainQuery.h"
#import "CCSSKeychain.h"

@implementation CCSSKeychainQuery
...
- (BOOL)save:(NSError *__autoreleasing *)error {
    ...
    if (status == errSecSuccess) {//item already exists, update it!
        ...
        CFTypeRef accessibilityType = [CCSSKeychain accessibilityType];
...
+ (NSError *)errorWithCode:(OSStatus) code {
    ...
    dispatch_once(&onceToken, ^{
        NSURL *url = [[NSBundle bundleForClass:[CCSSKeychainQuery class]] URLForResource:@"SAMKeychain" withExtension:@"bundle"];
