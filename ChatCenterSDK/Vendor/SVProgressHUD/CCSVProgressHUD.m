...
#import "CCSVIndefiniteAnimatedView.h"
#import "CCSVProgressAnimatedView.h"
#import "CCSVRadialGradientLayer.h"
...
@interface CCSVProgressHUD ()

@property (nonatomic, strong) NSTimer *fadeOutTimer;

@property (nonatomic, strong) UIControl *controlView;
@property (nonatomic, strong) UIView *backgroundView;
@property (nonatomic, strong) CCSVRadialGradientLayer *backgroundRadialGradientLayer;
...
@property (nonatomic, strong) CCSVProgressAnimatedView *ringView;
@property (nonatomic, strong) CCSVProgressAnimatedView *backgroundRingView;
...
@implementation CCSVProgressHUD {
    BOOL _isInitializing;
}

+ (CCSVProgressHUD*)sharedView {
    static dispatch_once_t once;
    
    static CCSVProgressHUD *sharedView;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        NSBundle *bundle = [NSBundle bundleForClass:[CCSVProgressHUD class]];
        NSURL *url = [bundle URLForResource:@"CCSVProgressHUD" withExtension:@"bundle"];
        ...
        self.accessibilityIdentifier = @"CCSVProgressHUD";
        self.accessibilityLabel = @"CCSVProgressHUD";
...
- (void)showProgress:(float)progress status:(NSString*)status {
    __weak CCSVProgressHUD *weakSelf = self;
    [[NSOperationQueue mainQueue] addOperationWithBlock:^{
        __strong CCSVProgressHUD *strongSelf = weakSelf;
        if(strongSelf){
...
- (UIView*)indefiniteAnimatedView {
    ...
    if(self.defaultAnimationType == SVProgressHUDAnimationTypeFlat){
        ...
        if(_indefiniteAnimatedView && ![_indefiniteAnimatedView isKindOfClass:[CCSVIndefiniteAnimatedView class]]){
            [_indefiniteAnimatedView removeFromSuperview];
            _indefiniteAnimatedView = nil;
        }
        
        if(!_indefiniteAnimatedView){
            _indefiniteAnimatedView = [[CCSVIndefiniteAnimatedView alloc] initWithFrame:CGRectZero];
        }
        
        // Update styling
        CCSVIndefiniteAnimatedView *indefiniteAnimatedView = (CCSVIndefiniteAnimatedView*)_indefiniteAnimatedView;
...
- (CCSVProgressAnimatedView*)ringView {
    if(!_ringView) {
        _ringView = [[CCSVProgressAnimatedView alloc] initWithFrame:CGRectZero];
    }
...
- (CCSVProgressAnimatedView*)backgroundRingView {
    if(!_backgroundRingView) {
        _backgroundRingView = [[CCSVProgressAnimatedView alloc] initWithFrame:CGRectZero];
    ...
    switch (self.defaultMaskType) {
        ...
        case SVProgressHUDMaskTypeGradient:{
            if(!_backgroundRadialGradientLayer){
                _backgroundRadialGradientLayer = [CCSVRadialGradientLayer layer];
            }
