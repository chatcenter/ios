...
@interface CCDACircularProgressLayer : CALayer
...
@implementation CCDACircularProgressLayer
...
@interface CCDACircularProgressView ()

@end

@implementation CCDACircularProgressView

+ (void) initialize
{
    if (self == [CCDACircularProgressView class]) {
        CCDACircularProgressView *circularProgressViewAppearance = [CCDACircularProgressView appearance];
...
+ (Class)layerClass
{
    return [CCDACircularProgressLayer class];
}

- (CCDACircularProgressLayer *)circularProgressLayer
{
    return (CCDACircularProgressLayer *)self.layer;
}
