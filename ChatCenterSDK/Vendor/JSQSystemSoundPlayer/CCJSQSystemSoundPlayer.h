...
/**
 Project version number for CCJSQSystemSoundPlayer.
 */
FOUNDATION_EXPORT double CCJSQSystemSoundPlayerVersionNumber;

/**
 Project version string for CCJSQSystemSoundPlayer.
 */
FOUNDATION_EXPORT const unsigned char CCJSQSystemSoundPlayerVersionString[];
 ...
 */
typedef void(^CCJSQSystemSoundPlayerCompletionBlock)(void);

/**
 The `CCJSQSystemSoundPlayer` class enables you to play sound effects, alert sounds, or other short sounds.
 ...
 */
@interface CCJSQSystemSoundPlayer : NSObject
...
/**
 Returns the shared `CCJSQSystemSoundPlayer` object. This method always returns the same sound system player object.
 
 @return A shared instance of `CCJSQSystemSoundPlayer`.
 */
+ (CCJSQSystemSoundPlayer *)sharedPlayer;

/**
 Returns a new `CCJSQSystemSoundPlayer` instance with the specified bundle.
 
 @param bundle The bundle in which the sound player uses to search for sound file resources.
 
 @return An initialized `CCJSQSystemSoundPlayer` object.
...
/**
 Returns a new `CCJSQSystemSoundPlayer` instance using the main bundle.
...
/**
 ...
 This will enable or disable the playing of sounds via `CCJSQSystemSoundPlayer` globally.
...
/**
 ...
 This block is retained by `CCJSQSystemSoundPlayer`, temporarily cached, and released after its execution.
...
- (void)playSoundWithFilename:(NSString *)filename
                fileExtension:(NSString *)fileExtension
                   completion:(nullable CCJSQSystemSoundPlayerCompletionBlock)completionBlock;
